...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/caryptocoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/caryptocoin-cli.cpp \
           src/caryptocoin-tx.cpp \
           src/caryptocoin.cpp \
           src/db.cpp \
           ...
           src/qt/caryptocoin.cpp \
           src/qt/caryptocoinstrings.cpp \
...
RESOURCES += src/qt/caryptocoin.qrc src/qt/caryptocoin_locale.qrc

TRANSLATIONS += src/qt/locale/caryptocoin_bg.ts \
                src/qt/locale/caryptocoin_de.ts \
                src/qt/locale/caryptocoin_en.ts \
                src/qt/locale/caryptocoin_es.ts \
                src/qt/locale/caryptocoin_fi.ts \
                src/qt/locale/caryptocoin_fr.ts \
                src/qt/locale/caryptocoin_it.ts \
                src/qt/locale/caryptocoin_ja.ts \
                src/qt/locale/caryptocoin_pl.ts \
                src/qt/locale/caryptocoin_pt.ts \
                src/qt/locale/caryptocoin_ru.ts \
                src/qt/locale/caryptocoin_sk.ts \
                src/qt/locale/caryptocoin_sv.ts \
                src/qt/locale/caryptocoin_vi.ts \
                src/qt/locale/caryptocoin_zh_CN.ts \
                src/qt/locale/caryptocoin_zh_TW.ts
