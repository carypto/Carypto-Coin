Contributing to Carypto Coin Core
==================================

The Carypto Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Carypto Coin Core project, and is not to be
confused with overall Carypto Coin Network Protocol consensus changes.

Whether a pull request is merged into Carypto Coin Core rests with the project merge
...
Patches that change Carypto Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Carypto Coin consensus, it must have been
...
The project leader is the release manager for each Carypto Coin Core release.
