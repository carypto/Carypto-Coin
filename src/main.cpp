...
#if defined(NDEBUG)
#error "Carypto Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ucac) are considered zero fee (for relaying and mining)
...
{
    RenameThread("caryptocoin-scriptch");
