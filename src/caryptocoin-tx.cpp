...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Carypto Coin Core caryptocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  caryptocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded carypto coin transaction") + "\n" +
                               "  caryptocoin-tx [options] -create [commands]   " + _("Create hex-encoded carypto coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded carypto coin transaction
