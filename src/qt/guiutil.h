...
/** Utility functions used by the CaryptoCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CAC addresses in monospace font
...
// Parse "caryptocoin:" URI into recipient object, return true on successful parsing
