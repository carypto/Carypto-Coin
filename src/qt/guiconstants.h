...
/* Carypto Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CaryptoCoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "CaryptoCoin-Qt"
#define QAPP_APP_NAME_TESTNET "CaryptoCoin-Qt-testnet"
