...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Carypto Coin Core"),
     ...
     * override -datadir in the caryptocoin.conf file in the default data directory
     * (to be consistent with caryptocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
