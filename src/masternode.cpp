...
bool CMasternodeBroadcast::CheckAndUpdate(int& nDos)
{
    ...
    //     if (addr.GetPort() != 9153) return false;
    // } else if (addr.GetPort() == 9153)
    //     return false;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when CAC collateral tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = 0;
    CTransaction tx2;
