...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Carypto Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Carypto Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Carypto Coin features */
        {"caryptocoin", "masternode", &masternode, true, true, false},
        {"caryptocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"caryptocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"caryptocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"caryptocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"caryptocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"caryptocoin", "startmasternode", &startmasternode, true, true, false},
        {"caryptocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"caryptocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"caryptocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"caryptocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"caryptocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"caryptocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"caryptocoin", "mnbudget", &mnbudget, true, true, false},
        {"caryptocoin", "preparebudget", &preparebudget, true, true, false},
        {"caryptocoin", "submitbudget", &submitbudget, true, true, false},
        {"caryptocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"caryptocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"caryptocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"caryptocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"caryptocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"caryptocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"caryptocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"caryptocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"caryptocoin", "mnsync", &mnsync, true, true, false},
        {"caryptocoin", "spork", &spork, true, true, false},
        {"caryptocoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"caryptocoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"caryptocoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"caryptocoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"caryptocoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"caryptocoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> caryptocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9152/\n";
}
