...
#   c) node1 mines 32 blocks, so now node 0 has 500000CAC, node 1 has 4250CAC, node2 has none.
#   d) node0 sends 601 CAC to node2, in two transactions (301 CAC, then 300 CAC).
