...
This mechanism has been integrated into Bitcore-Node-CaryptoCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/caryptocoin/insight-api-caryptocoin#web-socket-api](https://github.com/caryptocoin/insight-api-caryptocoin#web-socket-api)
* API: [https://github.com/caryptocoin/insight-api-caryptocoin#swifttx-transactions](https://github.com/caryptocoin/insight-api-caryptocoin#swifttx-transactions)
...
By default, the Carypto Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Carypto Coin Core daemon:
