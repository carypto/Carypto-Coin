...
Intro
-----
Carypto Coin (CAC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Carypto Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run caryptocoin-qt.exe.

Carypto Coin Core is the original Carypto Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Carypto Coin transactions;
