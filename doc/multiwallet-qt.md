...
In order to support loading of multiple wallets in caryptocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is caryptocoin.cpp.
...
Changes to caryptocoin.cpp
----------------------
caryptocoin.cpp is the entry point into caryptocoin-qt, and as such, will require some minor modifications to provide hooks for
